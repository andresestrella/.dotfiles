...
vim.api.nvim_set_keymap(
	"n",
	"<Leader>db",
	[[:lua require"dapui".float_element("breakpoints", {width = 130, height = 40, position = "center", enter = true})<CR>]],
	{ noremap = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<Leader>dw",
	[[:lua require"dapui".float_element('watches', {width = 130, height = 40, position = "center", enter = true})<CR>]],
	{ noremap = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<Leader>ds",
	[[:lua require"dapui".float_element('scopes', {width = 130, height = 40, position = "center", enter = true})<CR>]],
	{ noremap = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<Leader>dt",
	[[:lua require"dapui".float_element('stacks', {width = 130, height = 40, position = "center", enter = true})<CR>]],
	{ noremap = true }
)
