return {
	...
	init = function()
		...
		local mappings = {
		    ...
		    { "<leader>f", group = "Find", nowait = false, remap = true, silent = false },
		    { "<leader>fC", "<cmd>Telescope commands<cr>", desc = "Commands", nowait = false, remap = true, silent = false },
		    { "<leader>fG", "<cmd>Telescope git_branches<cr>", desc = "Checkout branch", nowait = false, remap = true, silent = false },
		    { "<leader>fH", "<cmd>Telescope highlights<cr>", desc = "Find highlight groups", nowait = false, remap = true, silent = false },
		    { "<leader>fM", "<cmd>Telescope man_pages<cr>", desc = "Man Pages", nowait = false, remap = true, silent = false },
		    { "<leader>fR", "<cmd>Telescope registers<cr>", desc = "Registers", nowait = false, remap = true, silent = false },
		    { "<leader>fb", "<cmd>Telescope buffers<cr>", desc = "Resume last search", nowait = false, remap = true, silent = false },
		    { "<leader>fc", "<cmd>Telescope colorscheme<cr>", desc = "Colorscheme", nowait = false, remap = true, silent = false },
		    { "<leader>fd", "<cmd>Telescope live_grep<cr>", desc = "live grep", nowait = false, remap = true, silent = false },
		    { "<leader>ff", "<cmd>Telescope find_files<cr>", desc = "Find File", nowait = false, remap = true, silent = false },
		    { "<leader>fg", "<cmd>Telescope git_files<cr>", desc = "Find Git Files", nowait = false, remap = true, silent = false },
		    { "<leader>fh", "<cmd>Telescope help_tags<cr>", desc = "Find Help", nowait = false, remap = true, silent = false },
		    { "<leader>fk", "<cmd>Telescope keymaps<cr>", desc = "Keymaps", nowait = false, remap = true, silent = false },
		    { "<leader>fl", "<cmd>Telescope resume<cr>", desc = "Resume last search", nowait = false, remap = true, silent = false },
		    { "<leader>fp", "<cmd>Telescope neoclip<cr>", desc = "Resume last search", nowait = false, remap = true, silent = false },
		    { "<leader>fq", "<cmd>Telescope macroscope<cr>", desc = "Find Help", nowait = false, remap = true, silent = false },
		    { "<leader>fr", "<cmd>Telescope oldfiles<cr>", desc = "Open Recent File", nowait = false, remap = true, silent = false },
		    { "<leader>ft", "<cmd>Telescope <cr>", desc = "Open Telescope", nowait = false, remap = true, silent = false },
		    { "<leader>fz", "<cmd>lua require('telescope.builtin').colorscheme({enable_preview = true})<cr>", desc = "Colorscheme with Preview", nowait = false, remap = true, silent = false },
		    { "<leader>g", group = "Git", nowait = false, remap = true, silent = false },
		    { "<leader>gC", "<cmd>Telescope git_bcommits<cr>", desc = "Checkout commit(for current file)", nowait = false, remap = true, silent = false },
		    ...
		    { "<leader>go", "<cmd>Telescope git_status<cr>", desc = "Open changed file", nowait = false, remap = true, silent = false },
		    ...
		    { "<leader>lS", "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>", desc = "Workspace Symbols", nowait = false, remap = true, silent = false },
		    { "<leader>la", "<cmd>lua vim.lsp.buf.code_action()<cr>", desc = "Code Action", nowait = false, remap = true, silent = false },
		    { "<leader>ld", "<cmd>Telescope diagnostics bufnr=0 theme=get_ivy<cr>", desc = "Buffer Diagnostics", nowait = false, remap = true, silent = false },
		    { "<leader>le", "<cmd>Telescope quickfix<cr>", desc = "Telescope Quickfix", nowait = false, remap = true, silent = false },
		    ...
		    { "<leader>ls", "<cmd>Telescope lsp_document_symbols<cr>", desc = "Document Symbols", nowait = false, remap = true, silent = false },
		    { "<leader>lw", "<cmd>Telescope diagnostics<cr>", desc = "Diagnostics", nowait = false, remap = true, silent = false },
		    ...
		    { "<leader>s", group = "Harpoon", nowait = false, remap = true, silent = false },
		    { "<leader>sa", "<cmd>lua require'harpoon.mark'.add_file()<CR>", desc = "add file", nowait = false, remap = true, silent = false },
		    { "<leader>si", "<cmd>lua require'harpoon.ui'.nav_file(2)<CR>", desc = "go to file 2", nowait = false, remap = true, silent = false },
		    { "<leader>so", "<cmd>lua require'harpoon.ui'.nav_file(3)<CR>", desc = "go to file 3", nowait = false, remap = true, silent = false },
		    { "<leader>sp", "<cmd>lua require'harpoon.ui'.nav_file(3)<CR>", desc = "go to file 4", nowait = false, remap = true, silent = false },
		    { "<leader>ss", "<cmd>lua require'harpoon.ui'.toggle_quick_menu()<CR>", desc = "toggle menu", nowait = false, remap = true, silent = false },
		    { "<leader>su", "<cmd>lua require'harpoon.ui'.nav_file(1)<CR>", desc = "go to file 1", nowait = false, remap = true, silent = false },
